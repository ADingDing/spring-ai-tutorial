...
public class VllmChatModelController {
    ...
    private static final String DEFAULT_PROMPT = "你好，介绍下临淄。2000个字内即可";
...
//        Prompt prompt = new Prompt(new UserMessage(DEFAULT_PROMPT));
        Prompt prompt = new Prompt(Arrays.asList(new UserMessage(DEFAULT_PROMPT)));
//        ChatResponse call = ChatModel.call(prompt);
    ...
    /**
     * 使用编程方式自定义 LLMs ChatOptions 参数， {@link OpenAiChatOptions}
